...
class AsyncYandexSearch(_BaseClient):
    """Asynchronous client for Yandex Search API."""
    ...
    async def search(
        ...
        *,
        ...
        data = await self._request("web/search", body)
    ...
    async def search_images(
        ...
        *,
        ...
        data = await self._request("image/search", body)
        return self._parse_image_response(data)

    async def gen_search(
        self,
        query: str,
        *,
        folder_id: str | None = None,
        ...
        data = await self._request("gen/search", body)
    ...
    async def __aenter__(self) -> AsyncYandexSearch:
        return self
